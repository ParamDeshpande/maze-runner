...
void display_states(void){
  ...
  Serial.print("x_pos " );
  Serial.print(current_states[0]);
  
  Serial.print("  current_vel ");
  Serial.print(current_states[1]);
  
  Serial.print("  acc ");
  Serial.print(current_states[2]);
  
  Serial.print("  yaw ");
  Serial.print(RADS_2_D(current_states[4]));

  Serial.print("  w ");
  Serial.print(current_states[5]);
